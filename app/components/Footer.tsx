...
export function Footer() {
  return (
    <footer className="relative bg-[#FAF9FB] border-t border-black/[0.06] text-text mt-auto overflow-hidden">
      {/* Architectural Giant BEAUTYINU Glass Effect Background (Flush with Top Edge) */}
      <div
        className="absolute top-0 inset-x-0 w-full flex items-start justify-center pointer-events-none select-none overflow-hidden z-0"
        aria-hidden="true"
      >
        <div className="relative w-full flex justify-center">
          {/* Top Glass Border Sheen */}
          ...
          <span className="text-[17vw] leading-[0.78] font-black font-sans uppercase tracking-[-0.04em] text-transparent bg-clip-text bg-gradient-to-b from-black/[0.07] via-black/[0.025] to-transparent whitespace-nowrap">
            BEAUTYINU
          </span>
        </div>
      </div>
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-16 lg:pt-20 pb-12">
        ...
        <div className="flex flex-col md:grid md:grid-cols-2 lg:flex lg:flex-row lg:justify-between items-start gap-10 md:gap-8 lg:gap-0">
          ...
          <div className="flex flex-col items-start w-full md:w-auto lg:w-[250px] xl:w-[260px] shrink-0">
            <NavLink to="/" className="inline-block focus:outline-none group mb-2.5" aria-label="Beautyinu Home">
              <img
                src={logoUrl}
          ...
          <div className="w-full md:w-auto lg:w-[320px] xl:w-[350px] shrink-0">
            <div className="rounded-3xl bg-white border border-black/[0.06] p-5 sm:p-6 space-y-3.5 shadow-2xs">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[10px] font-mono uppercase tracking-widest text-black/50 border border-black/10 px-2 py-0.5 rounded-full">
                  Fast Response
                </span>
              </div>
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2.5 w-full py-2.5 px-4 rounded-full bg-[#111111] hover:bg-[#25D366] text-white text-xs font-semibold tracking-wider transition-all duration-300 shadow-xs hover:shadow-md hover:shadow-emerald-500/20 cursor-pointer"
              >
                <svg className="w-3.5 h-3.5 fill-current text-white flex-shrink-0" viewBox="0 0 24 24">
                ...
                <span className="font-mono tracking-wider">+62 877-7711-8186</span>
              </a>
              <div className="text-[11px] text-text-secondary/70 pt-2 leading-relaxed border-t border-black/[0.04] space-y-1">
