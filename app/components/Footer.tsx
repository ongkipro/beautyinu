          ...
          <div className="w-full md:w-auto lg:w-[320px] xl:w-[350px] shrink-0">
            <div className="rounded-3xl bg-white border border-black/[0.06] p-5 sm:p-6 space-y-3.5 shadow-2xs">
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2.5 w-full py-2.5 px-4 rounded-full bg-[#111111] hover:bg-black text-white text-xs font-semibold tracking-wider transition-all cursor-pointer"
              >
