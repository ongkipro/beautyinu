  ...
  'bright-glow-body-lotion-uv-filter-750ml': {
    ...
    reviewsList: [
      ...
      },
      {
        ...
        variant: '750ml UV Filter',
        content:
          'Suka banget teksturnya gak licin pas wudhu atau cuci tangan, cepat menyerap ke lapisan kulit. Pemakaian 10 hari kulit terasa lebih halus dan cerah merata.',
        helpfulCount: 45,
        hasMedia: true,
      },
      {
        ...
        variant: '750ml UV Filter',
        content:
          'Kulit tangan yang sering belang karena naik motor perlahan warnanya mulai balik rata dan kenyal. Wanginya nempel sampai sore, recommended!',
        helpfulCount: 29,
        hasMedia: true,
      },
      {
        ...
        variant: '750ml UV Filter',
        content:
          'Packaging pengiriman aman pakai kardus tebal dan bubble wrap. Pump botolnya lancar gak macet, formulanya ringan dan bikin kulit lembap seharian.',
        helpfulCount: 21,
        hasMedia: false,
      },
      {
        id: 'rev-lotion-8',
        name: 'nadia_wulandari',
        avatar: 'NW',
        rating: 5,
        date: '1 bulan lalu',
        variant: '750ml UV Filter',
        content:
          'Rekomendasi temen kantor, wanginya calming banget gak menyengat. Udah repeat order botol kedua buat stok.',
        helpfulCount: 18,
        hasMedia: false,
      },
      {
        ...
        variant: '750ml UV Filter',
        content:
          'Tekstur losionnya lembut banget dan bikin cerah alami bukan dempul instan. Kulit kering jadi jauh lebih tenang.',
        helpfulCount: 14,
        hasMedia: false,
      },
      {
        ...
        variant: '750ml UV Filter',
        content:
          'Kombinasi terbaik bareng sabun kefir Beautyinu. Kulit bersih, lembap, dan cerah terawat setiap hari.',
        helpfulCount: 33,
        hasMedia: true,
        sellerReply:
          'Terima kasih Kak Putri! Sinergi sabun kefir dan lotion UV memang kombinasi harian paling favorit untuk menjaga skin barrier sehat.',
      },
    ],
  },
  ...
  'brightening-booster-gold-powder-25gr': {
    ...
    reviewsList: [
      ...
      },
      {
        ...
        variant: 'Gold Powder 25gr',
        content:
          'Hasilnya bagus bikin kulit glowing sehat. Jangan dipakai langsung ke kulit ya, wajib dicampur losion atau cream dulu biar gampang diratakan. Recommended buat yang mau upgrade rutinitas bodycare.',
        helpfulCount: 31,
        hasMedia: false,
      },
      {
        ...
        variant: 'Gold Powder 25gr',
        content:
          'Bikin losion biasa jadi booster pencerah level premium. Partikel emasnya halus banget gak berasa kasar di kulit.',
        helpfulCount: 52,
        hasMedia: true,
      },
      {
        ...
        variant: 'Gold Powder 25gr',
        content:
          'Bekas gigitan nyamuk dan bintik gelap di kaki mulai samar setelah rutin 3 minggu dicampur ke lotion malam.',
        helpfulCount: 39,
        hasMedia: true,
      },
      {
        ...
        variant: 'Gold Powder 25gr',
        content:
          'Kemasannya compact dan higienis. Botol segel rapat saat diterima dari ekspedisi.',
        helpfulCount: 22,
        hasMedia: false,
      },
      {
        ...
        variant: 'Gold Powder 25gr',
        content:
          'Kombinasi wajib bareng body lotion 750ml, hasilnya cerah sehat gak bikin warna kulit jadi abu-abu.',
        helpfulCount: 28,
        hasMedia: false,
      },
      {
        ...
        variant: 'Gold Powder 25gr',
        content:
          'Bubuknya halus dan cepat larut. Aromanya netral jadi gak tabrakan sama wangi losion yang dipakai.',
        helpfulCount: 16,
        hasMedia: false,
      },
      {
        ...
        variant: 'Gold Powder 25gr',
        content:
          'Repurchase ke-3 kalinya, bener-bener produk andalan buat maintain kulit glowing cerah.',
        helpfulCount: 41,
        hasMedia: true,
      },
    ],
  ...
  'kefir-collagen-soap-60gr': {
    ...
    reviewsList: [
      ...
      },
      {
        ...
        variant: 'Soap Bar 60gr',
        content:
          'Wanginya bikin rileks saat mandi sore, kulit terasa kenyal seketika setelah dibilas.',
        helpfulCount: 34,
        hasMedia: false,
      },
      {
        ...
        variant: 'Soap Bar 60gr',
        content:
          'Busa melimpah dan tidak perih di kulit. Pori-pori terasa bersih maksimal tanpa rasa kering.',
        helpfulCount: 42,
        hasMedia: true,
      },
      {
        ...
        variant: 'Soap Bar 60gr',
        content:
          'Sabun kefir paling nyaman dipakai harian. Warna kulit belang di pundak mulai merata.',
        helpfulCount: 26,
        hasMedia: false,
      },
      {
        ...
        variant: 'Soap Bar 60gr',
        content:
          'Aman untuk kulit yang gampang sensitif, gak memicu gatal atau kemerahan sama sekali.',
        helpfulCount: 19,
        hasMedia: false,
      },
      {
        ...
        variant: 'Soap Bar 60gr',
        content:
          'Busa creamy banget. Setelah mandi kulit berasa bersih dan halus.',
        helpfulCount: 15,
        hasMedia: false,
      },
      {
        ...
        variant: 'Soap Bar 60gr',
        content:
          'Pengiriman kilat Surabaya ke Bandung cuma 2 hari. Sabun masih fresh dan aromanya wangi lembut.',
        helpfulCount: 23,
        hasMedia: true,
      },
      {
        ...
        variant: 'Soap Bar 60gr',
        content:
          'Paket bundling sabun dan losionnya bener-bener kombinasi juara buat mencerahkan kulit.',
        helpfulCount: 38,
        hasMedia: true,
      },
    ],
  ...
  'brightening-body-cream-grape': {
    ...
    reviewsList: [
      ...
      },
      {
        ...
        variant: 'Ukuran 200gr Grape',
        content:
          'Bagus banget dipakai malam hari sebelum tidur. Paginya kulit kerasa halus banget dan glowing sehat.',
        helpfulCount: 44,
        hasMedia: true,
      },
      {
        ...
        variant: 'Ukuran 200gr Grape',
        content:
          'Teksturnya kental bernutrisi, pakainya tipis-tipis aja udah cukup melembapkan semalaman.',
        helpfulCount: 27,
        hasMedia: false,
      },
      {
        ...
        variant: 'Ukuran 100gr Travel',
        content:
          'Kemasan 100gr mungil pas di pouch makeup. Wangi anggurnya awet dan segar.',
        helpfulCount: 19,
        hasMedia: false,
      },
    ],
  ...
  'the-glowing-set': {
    ...
    reviewsList: [
      ...
      },
      {
        ...
        variant: 'The Glowing Set (3-in-1)',
        content:
          'Suka banget sama paket ini, lengkap dan praktis gak perlu mikir mix match produk lain lagi. Hasilnya optimal banget di kulit.',
        helpfulCount: 48,
        hasMedia: false,
      },
      {
        ...
        variant: 'The Glowing Set (3-in-1)',
        content:
          'Paket hemat berkualitas. Botol losionnya besar banget, sabunnya lembut, boosternya gampang larut.',
        helpfulCount: 31,
        hasMedia: false,
      },
      {
        ...
        variant: 'The Glowing Set (3-in-1)',
        content:
          'Bikin kulit glowing natural dan sehat. Worth it banget harganya untuk 3 produk unggulan sekaligus.',
        helpfulCount: 62,
        hasMedia: true,
      },
    ],
  ...
  reviewsList: [
    {
      ...
      hasMedia: true,
      sellerReply:
        'Terima kasih atas kepercayaannya pada Beautyinu. Rawat terus kulit sehatmu bersama rangkaian formula aktif kami!',
    },
    {
      id: 'rev-def-2',
      name: 'siti_rahmah',
      ...
      variant: 'Original Formula',
      content:
        'Kualitas produk sangat bagus, wangi lembut dan nyaman dipakai setiap hari. Pengiriman aman dengan packing bubble tebal.',
      helpfulCount: 28,
      hasMedia: false,
    },
    {
      ...
      variant: 'Original Formula',
      content:
        'Suka banget sama rangkaian perawatan Beautyinu. Kulit terasa lebih lembap, kenyal, dan warnanya lebih merata.',
      helpfulCount: 19,
      hasMedia: true,
    },
    {
      ...
      variant: 'Original Formula',
      content:
        'Teksturnya sangat ringan dan mudah diratakan. Tidak meninggalkan rasa lengket atau gerah di kulit sama sekali.',
      helpfulCount: 15,
      hasMedia: true,
    },
    {
      ...
      variant: 'Original Formula',
      content:
        'Sudah habis 2 botol dan hasilnya kelihatan nyata. Kulit yang tadinya kusam jadi lebih cerah natural dan sehat.',
      helpfulCount: 22,
      hasMedia: false,
    },
    {
      ...
      variant: 'Original Formula',
      content:
        'Pengiriman cepat dari Surabaya, botol aman tidak bocor. Wanginya enak segar dan bikin kulit halus seketika.',
      helpfulCount: 8,
      hasMedia: true,
    },
    {
      ...
      variant: 'Original Formula',
      content:
        'Bahan aktifnya transparan dan ada nomor BPOM resmi jadi tenang pakainya jangka panjang. Formula jempolan.',
      helpfulCount: 17,
      hasMedia: true,
    },
    {
      ...
      variant: 'Original Formula',
      content:
        'Pemakaian teratur benar-benar menjaga kelembapan kulit seharian di ruangan ber-AC. Sangat recommended.',
      helpfulCount: 11,
      hasMedia: false,
    },
    {
      ...
      variant: 'Original Formula',
      content:
        'Serum dan losionnya cepat meresap ke kulit. Kulit terasa lebih lembut dan elastis setelah rutin pakai.',
      helpfulCount: 14,
      hasMedia: true,
    },
    {
      ...
      variant: 'Original Formula',
      content:
        'Sesuai deskripsi, produk original dan tersegel rapi. Cocok untuk semua tipe kulit tanpa iritasi.',
      helpfulCount: 9,
      hasMedia: false,
    },
  ],
